...
function(use_glove=false, use_bert=true,
         disable_known_entities=false,
         disable_dialog_acts=false,
         disable_likes=false,
         disable_facts=false) {
    train_data_path: '/data/users/shanemoon/dialog-data/folded/1127/curiosity_dialogs.train.json',
    validation_data_path: '/data/users/shanemoon/dialog-data/folded/1127/curiosity_dialogs.val.json',
    dataset_reader: {
        type: 'baseline_curiosity_dialog',
    ...
    model: {
        ...
        mention_embedder: {
            mentions: {
                ...
                pretrained_file: "/data/users/shanemoon/wiki2vec_entity_100d.txt",
            },
        },
